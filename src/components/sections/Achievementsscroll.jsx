...
const achievementsData = [
  ...
  },
  {
    ...
    description:
      "FOUNDED IN 2003, HALSTON HAS BUILT A SPECIALIST ARCHITECTURAL PRACTICE OVER 23 YEARS OF FOCUSED WORK IN RESIDENTIAL, COMMERCIAL, AND CULTURAL ARCHITECTURE.",
    image:
